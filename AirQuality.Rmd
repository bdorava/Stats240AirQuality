...
#### Buoy Data ####
buoy_data = read_table("Stats240AirQuality/data/2021Buoy.txt") %>% 
  full_join(read_table("Stats240AirQuality/data/2022Buoy.txt")) %>% #Join both years of buoy data
  rename(year = "#YY",
         month = "MM",
         day = "DD",
         hour = "hh",
...
#### Ground Data ####
ground_data = read_excel("Stats240AirQuality/data/2021Chiwaukee.xls", skip=2) %>% 
  full_join(read_excel("Stats240AirQuality/data/2022Chiwaukee.xlsx", skip=2)) %>% #Join both years of air quality data
...
>>>>>>> fbd79b3d2f0b14819c2e073695caef1bb3a61321
