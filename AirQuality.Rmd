...
This caused outliers to become more visually apparent, so sample sizes were included to prevent hasty conclusions.
...
Perhaps most apparently, the region nearest the origin has the lowest mean ozone concentration.

The top left region bounded by 
